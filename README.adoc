...
repman replaces https://gitlab.com/mipimipi/crema[crema] which is no longer under development and adds new features. It can run on x86_64 and AArch64 (armv8 64-bit) and thus can manage repositories for these architectures.
